  ...
  return (
    <div className="w-full">
      ...
      <section className="relative bg-[#1A3A5C] text-white overflow-hidden" aria-label="Hero section">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 flex flex-col lg:flex-row items-center gap-12 z-10">
          <div className="lg:w-1/2 text-center lg:text-left">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="inline-flex items-center gap-2 bg-[#C9A84C]/20 border border-[#C9A84C]/40 rounded px-4 py-1.5 text-sm text-[#F0D080] mb-6"
            >
            ...
            <motion.p
              ...
              className="text-lg text-[#A8C4D8] mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed"
            >
            ...
            >
              <Link
                to="/admissions"
                className="bg-[#8B1A1A] hover:bg-[#7a1616] text-white font-semibold py-3 px-8 rounded transition-colors flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-[#C9A84C]"
              >
                Apply Now <ArrowRight className="w-5 h-5" aria-hidden="true" />
              </Link>
              <Link
                to="/courses"
                className="bg-transparent hover:bg-white/10 border border-[#A8C4D8] text-white font-semibold py-3 px-8 rounded transition-colors flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-[#C9A84C]"
              >
                Explore Programs
              </Link>
            </motion.div>
            ...
            <div className="w-full aspect-video rounded-lg border border-white/10 shadow-2xl overflow-hidden relative">
              ...
              <div className="absolute bottom-4 left-4 flex gap-3">
                {[
                  ...
                  <div key={s.label} className="bg-black/30 backdrop-blur-sm border border-white/20 rounded px-3 py-2 text-center">
                    <p className="text-lg font-bold text-[#C9A84C]">{s.val}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/20">
            {stats.map((stat) => {
              ...
              return (
                <div key={stat.label} className="flex flex-col items-center gap-1.5 py-2 px-4">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14" aria-label="Notice board and quick links">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">

          {/* Quick Links */}
          <div className="lg:col-span-2">
            <h2 className="text-2xl font-bold text-[#1A3A5C] mb-6 flex items-center gap-2">
              ...
              {quickLinks.map((link) => {
                ...
                return (
                  <Link
                    key={link.path}
                    to={link.path}
                    className="bg-white rounded-lg border border-[#E8E4DC] p-5 hover:shadow-lg hover:-translate-y-0.5 hover:border-[#8B1A1A]/30 transition-all duration-200 flex flex-col items-center text-center group focus:outline-none focus:ring-2 focus:ring-[#8B1A1A]"
                  >
                    <div className="w-12 h-12 bg-[#F5EDE8] text-[#8B1A1A] rounded-lg flex items-center justify-center mb-3 group-hover:bg-[#8B1A1A] group-hover:text-white transition-colors">
                      <Icon className="w-6 h-6" aria-hidden="true" />
                    </div>
                    <h3 className="text-sm font-bold text-[#1E1E1E] mb-1">{link.name}</h3>
          ...
          <div className="bg-white rounded-lg border border-[#E8E4DC] overflow-hidden flex flex-col shadow-sm" aria-label="Notice board">
            ...
            <div className="flex-grow overflow-hidden relative h-[300px]">
      ...
      {/* ── About Snippet ── */}
      <section className="bg-[#F0EDE8] py-16 border-y border-[#E8E4DC]" aria-labelledby="about-home-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-[#8B1A1A] text-sm font-semibold uppercase tracking-widest mb-2">About the Institution</p>
              <h2 id="about-home-heading" className="text-3xl font-extrabold text-[#1A3A5C] mb-4 leading-tight">
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  to="/about"
                  className="flex items-center gap-2 bg-[#8B1A1A] hover:bg-[#7a1616] text-white font-semibold py-2.5 px-5 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-[#8B1A1A]"
                >
                  Learn More <ChevronRight className="w-4 h-4" aria-hidden="true" />
                </Link>
                <Link
                  to="/iqac"
                  className="flex items-center gap-2 bg-white hover:bg-[#F5EDE8] text-[#1A3A5C] border border-[#E8E4DC] font-semibold py-2.5 px-5 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-[#8B1A1A]"
                >
                  NAAC Reports
                </Link>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                return (
                  <div key={item.title} className={`${item.bg} rounded-lg p-5 border border-[#E8E4DC]`}>
                    <Icon className={`w-8 h-8 mb-3 ${item.iconColor}`} aria-hidden="true" />
                    <h3 className="font-bold text-[#1E1E1E] text-sm">{item.title}</h3>
      ...
      {/* ── Departments Preview ── */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14" aria-labelledby="departments-home-heading">
        <div className="flex items-center justify-between mb-8">
          <h2 id="departments-home-heading" className="text-2xl font-bold text-[#1A3A5C] flex items-center gap-2">
            <span className="w-1 h-6 bg-[#8B1A1A] rounded-full inline-block" aria-hidden="true"></span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {[
            ...
            <Link
              key={dept.name}
              to="/departments"
              className="bg-white rounded-lg p-4 text-center border border-[#E8E4DC] hover:shadow-md hover:border-[#8B1A1A]/30 hover:-translate-y-0.5 transition-all focus:outline-none focus:ring-2 focus:ring-[#8B1A1A]"
            >
              <span className="text-3xl block mb-2" role="img" aria-label={dept.name}>{dept.icon}</span>
      ...
      <section className="bg-[#1A3A5C] text-white py-12" aria-labelledby="ugc-compliance-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 id="ugc-compliance-heading" className="text-lg font-bold mb-1 text-white">
            Mandatory Disclosures & UGC Compliance
          </h2>
          <p className="text-[#A8C4D8] text-sm mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <Link
                ...
                to={item.path}
                className="px-4 py-2 bg-white/10 hover:bg-[#8B1A1A] border border-white/20 hover:border-[#8B1A1A] text-[#A8C4D8] hover:text-white rounded text-sm font-medium transition-all focus:outline-none focus:ring-2 focus:ring-[#C9A84C]"
              >
                {item.label}
              </Link>
            ))}
